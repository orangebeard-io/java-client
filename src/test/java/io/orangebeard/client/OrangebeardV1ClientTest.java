...
class OrangebeardV1ClientTest {
    ...
    public void when_the_connection_is_valid_a_log_is_reported_to_orangebeard() {
        OrangebeardV1Client orangebeardClient = new OrangebeardV1Client(restTemplate, "http://localhost:8080", UUID.fromString("92580f91-073a-4bf7-aa10-bb4f8dbcb534"), "project", true);
    ...
    public void when_the_connection_is_invalid_no_log_is_reported_to_orangebeard() {
        OrangebeardV1Client orangebeardClient = new OrangebeardV1Client(restTemplate, "http://localhost:8080", UUID.fromString("92580f91-073a-4bf7-aa10-bb4f8dbcb534"), "project", false);
    ...
    public void when_the_connection_throws_a_gateway_timeout_exception_this_is_properly_handled() {
        when(restTemplate.exchange(eq("http://localhost:8080/listener/v1/project/log"), eq(POST), any(), eq(Response.class))).thenThrow(new HttpServerErrorException(HttpStatus.GATEWAY_TIMEOUT, "error!"));
