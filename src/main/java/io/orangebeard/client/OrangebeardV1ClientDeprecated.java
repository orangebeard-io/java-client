 ...
 */
@Deprecated
public class OrangebeardV1ClientDeprecated extends AbstractClient {
    private static final Logger LOGGER = LoggerFactory.getLogger(OrangebeardV1ClientDeprecated.class);
    private final String endpoint;
    private final RestTemplate restTemplate;
    private final String projectName;
    private boolean connectionWithOrangebeardIsValid;

    public OrangebeardV1ClientDeprecated(String endpoint, UUID uuid, String projectName, boolean connectionWithOrangebeardIsValid) {
        super(uuid);
    ...
    public OrangebeardV1ClientDeprecated(RestTemplate restTemplate, String endpoint, UUID uuid, String projectName, boolean connectionWithOrangebeardIsValid) {
        super(uuid);
